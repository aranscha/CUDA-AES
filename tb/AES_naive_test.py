...
def test1_RoundTest():
    ...
    result_gpu = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16)[0]
...
def test2_RoundTest():
    ...
    graphicscomputer = AESTest()
    result_gpu = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 32)[0]
    assert np.array_equal(result_gpu, byte_array_ref)
...
def test3_RoundTest():
    ...
    graphicscomputer = AESTest()
    result_gpu = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 192)[0]
    assert np.array_equal(result_gpu, byte_array_ref)
...
def test4_RoundTest():
    ...
    graphicscomputer = AESTest()
    result_gpu = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, byte_array_in.size)[0]
    assert np.array_equal(result_gpu, byte_array_ref)
